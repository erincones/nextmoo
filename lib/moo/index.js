 ...
 * @property {number} [wrap] Wrap column
 */
 ...
 * @returns {string} Cow
 */
export const moo = (message, { action = `say`, cow, mode, eyes, tongue, wrap }) => {
  // Get cow and face
 ...
 * @returns {string} Cow
 */
export const cowthink = (message, options) => moo(message, { actions: `think`, ...options });
