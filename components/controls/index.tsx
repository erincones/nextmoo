...
export const Controls = (): JSX.Element => {
  ...
  const handleEyesChange = useCallback(
  ...
  // Tongue change handler
  const handleTongueChange = useCallback(
    (e: ChangeEvent<HTMLInputElement>): void => {
      const { value, selectionStart } = e.currentTarget;
  ...
  return (
    <section className="p-2 w-full md:w-5/12 min-h-full">
      <form
        noValidate
            ...
            <fieldset className="border border-white px-2 pb-2 ml-4 w-7/12">
              ...
              <div role="radiogroup" className="flex">
                ...
                <Radio
                  ...
                  id="think"
                  value="think"
                  checked={action === `think`}
                  onChange={handleActionChange}
                  className="pl-2 w-4/7"
                >
                  Think
                </Radio>
              </div>
            ...
            <fieldset className="border border-white px-2 pb-2 w-full">
              ...
              <div className="flex">
                <Spinbox
                  ...
                  className="pr-2 w-5/12"
                />
                <Checkbox
                  id="no-wrap"
                  checked={noWrap}
                  onClick={handleNoWrapClick}
                  onChange={handleNoWrapChange}
                  className="pl-2 ml-4 w-7/12"
                >
                  No wrap
                </Checkbox>
              </div>
        ...
        <div className="md:flex-grow">
          <fieldset className="border border-white px-2 pb-2 mb-2 w-full md:h-full">
            ...
            <textarea
              ...
              className="bg-black text-white focus:outline-none w-full min-h-20 md:min-h-full resize-y md:resize-none"
            />
          </fieldset>
        </div>
      </form>
